...
{
    public class ProduceMachineGrabber : MonoBehaviour
    {
        ...
        public bool TryReleaseItem(EntityBehaviour playerEntityBehavior, float interactionRadius, LayerMask socketLayer, Collider[] overlapResults)
        {
            ...
            if (!socketEntity.hasProduceMachine || socketEntity.hasGrabbedItem || socketEntity.produceMachine.From != grabbableId) 
                return false;
