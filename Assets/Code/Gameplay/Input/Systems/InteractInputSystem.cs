...
namespace Code.Gameplay.Input.Systems
{
    public class InteractInputSystem : IExecuteSystem
    {
        ...
        public InteractInputSystem(IInputService inputService, CommonStaticData staticData)
        {
        ...
        public void Execute()
        {
            ...
            foreach (GameEntity entity in _inputEntities)
            {
                ...
                {
                    // Всегда регистрируем одиночное нажатие
                    ...
                    if (entity.hasTimeOfInteractDownInput)
                    {
                        ...
                        {
                            // Дополнительно регистрируем двойное нажатие
